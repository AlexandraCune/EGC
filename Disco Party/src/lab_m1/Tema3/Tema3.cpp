...
void Tema3::Update(float deltaTimeSeconds)
{
    ...
    //MoveDancer(deltaTimeSeconds, direction1, cubePosition, step1);
    ...
    for(Square s:squares)
    {
        ...
        if (sceneType == 1) {
            ...
            //    modelMatrix1 = glm::translate(modelMatrix1, glm::vec3(s.position.x - 0.5, 1, s.position.z));
            //    modelMatrix1 = glm::scale(modelMatrix1, glm::vec3(0.02, 0.1, 0.02));
            //    modelMatrix1 = glm::rotate(modelMatrix1, RADIANS(90.0f), glm::vec3(0, 0, 1));
            //    modelMatrix1 = glm::rotate(modelMatrix1, RADIANS(180.0f), glm::vec3(1, 0, 0));

            //    lightColor[0] = cubelightColor[0][(int)round(s.position.z)];
            //    lightColor[1] = glm::vec3(0, 0, 0);
            //    lightColor[2] = glm::vec3(0, 0, 0);
            //    lightColor[3] = glm::vec3(0, 0, 0);
            ...
            //    lightPosition[0] = glm::vec3(0, 0, s.position.z);
            ...
            //    //RenderSimpleMesh2(meshes["plane"], shaders["Floor"], modelMatrix1, s.color);
    ...
    if (sceneType == 3) {
       ...
       // lightDirection = glm::vec3(0, -1, 0);
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.25, 0.75, 0.75), lightColor, lightPosition);
        //lightDirection = glm::vec3(0, 1, 0);
        //RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix1, glm::vec3(0.25, 0.75, 0.75), lightColor, lightPosition);
        modelMatrix1 = glm::mat4(1);
...
void Tema3::OnInputUpdate(float deltaTime, int mods)
{
    ...
    //    if (window->KeyHold(GLFW_KEY_A)) cubePosition -= right * deltaTime * speed;
    //    if (window->KeyHold(GLFW_KEY_S)) cubePosition += forward * deltaTime * speed;
    //    if (window->KeyHold(GLFW_KEY_D)) cubePosition += right * deltaTime * speed;
    //    if (window->KeyHold(GLFW_KEY_E)) cubePosition += up * deltaTime * speed;
    //    if (window->KeyHold(GLFW_KEY_Q)) cubePosition -= up * deltaTime * speed;

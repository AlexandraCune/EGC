...
void Tema2::Init()
{
    ...
    {
        Mesh* healthLvl = obj2D::CreateSquare("healthLvl", cornerSquare, healthLvlX, healthLvlY, glm::vec3(0.1, 0.9, 0), true);
    ...
    {
        Mesh* timeLvl = obj2D::CreateSquare("timeLvl", cornerSquare, healthLvlX, healthLvlY,  glm::vec3(0.1, 0.9, 1), true);

...
void Tema1::Init()
{
	...
	Mesh* bullet = object2D_new::CreateCircle("bullet", cornerCircle, radiusBullet, glm::vec3(0, 0, 0), 360, true);
	AddMeshToList(bullet);
	Mesh* square2 = object2D_new::CreateSquare("square2", cornerSquare, x, y, glm::vec3(0.6, 0.1, 1), true);
	AddMeshToList(square2);
	Mesh* square1 = object2D_new::CreateSquare("square1", cornerSquare, MAX_MAP, MAX_MAP, glm::vec3(0.7, 0.6, 0.9), true);
	AddMeshToList(square1);

	
	Mesh* pupil = object2D_new::CreateCircle("pupil", cornerCircle, 0.05f, glm::vec3(0.2, 0, 1), 360, true);
	AddMeshToList(pupil);
	Mesh* iris = object2D_new::CreateCircle("iris", cornerCircle, 0.09f, glm::vec3(0.6, 0.9, 0.8), 360, true);
	AddMeshToList(iris);
	Mesh* eyes_contur = object2D_new::CreateCircle("eyes_contur", cornerCircle, 0.1f, glm::vec3(1, 0.3, 0.8), 360, false);
	AddMeshToList(eyes_contur);
	Mesh* body = object2D_new::CreateCircle("body", cornerCircle, radiusCircle, glm::vec3(1, 0.4, 0.7), 360, true);
	AddMeshToList(body);


	Mesh* enemy_iris = object2D_new::CreateCircle("enemy_iris", cornerCircle, 0.05f, glm::vec3(1, 0, 0.4), 360, true);
	AddMeshToList(enemy_iris);
	Mesh* enemy_pupil = object2D_new::CreateCircle("enemy_pupil", cornerCircle, 0.025f, glm::vec3(0, 0, 0), 360, true);
	AddMeshToList(enemy_pupil);
	Mesh* enemy_eye = object2D_new::CreateCircle("enemy_eye", cornerCircle, 0.1f, glm::vec3(0.9, 0.5, 0.8), 360, true);
	AddMeshToList(enemy_eye);
	Mesh* enemy_body = object2D_new::CreateCircle("enemy_body", cornerCircle, radiusCircle, glm::vec3(1, 1, 1), 360, true);
	AddMeshToList(enemy_body);

	Mesh* pick_up = object2D_new::CreateCircle("pick_up", cornerCircle, pickUpRadius, glm::vec3(0.9, 1, 0), 360, true);
	AddMeshToList(pick_up);
	Mesh* pick_up1 = object2D_new::CreateCircle("pick_up1", cornerCircle, pickUpRadius, glm::vec3(1, 0, 0), 360, true);
	AddMeshToList(pick_up1);



	Mesh* healthBar = object2D_new::CreateSquare("healthBar", cornerSquare, healthBarX, healthBarY, glm::vec3(1, 0, 0), false);
	AddMeshToList(healthBar);

	Mesh* healthLvl = object2D_new::CreateSquare("healthLvl", cornerSquare, healthLvlX, healthLvlY, glm::vec3(0.1, 0.9, 0), true);
